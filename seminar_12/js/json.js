const productBox = document.querySelector('.demo'); // родительский элемент
    ...
    const productImgFoto = document.createElement(`img`); // создаем фото
    productImgFoto.setAttribute(`alt`,productsData.alt); // присватваем значение alt    
    productImgFoto.src = productsData.src; // приваиваем фото
    ...
    productEl.appendChild(productImgFoto);  //добавляем фото в div
